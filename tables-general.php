...
<head>
  ...
  <style>
    ...
    th.asc:after {
      content: " \2191"; /* Unicode arrow up */
    }
    th.desc:after {
      content: " \2193"; /* Unicode arrow down */
    }
  </style>
          ...
          <div class="card">
            <class="card-body">
              ...
              echo    "<tr>
                          ...
                          <td>$tanggal</td>
                          <td>
                              <a href='edit1.php?namatoko=$namatoko'>Edit</a>
                              |
                              <a href='hapus1.php?namatoko=$namatoko' onclick=\"return confirm('Anda yakin mau menghapus data ini?')\">Delete</a>
                          </td>
                      <tr>";
              $n++;
              }

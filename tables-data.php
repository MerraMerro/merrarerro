        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p>Mohon update stok barang jika ada pembelian.</p>
              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  echo    "<tr>
                              ...
                              <td>$stok</td>
                              <td>
                                  <a href='edit2.php?kode=$kode'>Edit</a>
                                  |
                                  <a href='hapus2.php?kode=$kode' onclick=\"return confirm('Anda yakin mau menghapus data ini?')\">Delete</a>
                              </td>
                          <tr>";
                  $n++;
                  }

            ...
            <div class="card-body">
              ...
              <form action="submit.php" method="post">
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control "  id="namaCustomer"name="namatoko" required>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <select class="form-select" aria-label="Default select example" id="kodeBarang"name="kode"required>
                      <option  value="ACR21Q">ACR21Q</option>
                      <option  value="ACR514">ACR514</option>
                      <option  value="AMD560">AMD560</option>
                      <option  value="CV216G">CV216G</option>
                      <option  value="GB550D">GB550D</option>
                      <option  value="ITLS23">ITLS23</option>
                      <option  value="LGT203">LGT203</option>
                      <option  value="MSIG63">MSIG63</option>
                      <option  value="POCOX5">POCOX5</option>
                      <option  value="SRX580">SRX580</option>
                    </select>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control" maxlength="2" id="totalProduk" name="totalp"required>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="date" class="form-control" id="tanggalBeli" name="tanggalb"required>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <button type="submit" class="btn btn-primary" style="background-color:#b16b20;">Submit Form</button>
                  </div>
                </div>

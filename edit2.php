<html>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">Tabel</a></li>
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form name="fupdate" action="update2.php" method="post">
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Kode Produk</label>
                  <div class="col-sm-10">
                    <input name="kode" size="10" maxlength="6" value="<?php echo $row['kode']; ?>">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input name="nama" size="55" value="<?php echo $row['nama']; ?>">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input name="harga" size="75" value="<?php echo $row['harga']; ?>">
                  </div>
                </div>

                <div class="row mb-3">
                  <label for="inputDate" class="col-sm-2 col-form-label">Stok Produk</label>
                  <div class="col-sm-10">
                    <input name="stok" size="75" value="<?php echo $row['stok']; ?>">
                  </div>
                </div>
